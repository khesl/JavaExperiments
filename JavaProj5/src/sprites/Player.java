...
public class Player {
    ...
    //public Player() throws IOException {
        image = new Texture("src/res/assets/player.png"); //("src/res/assets/player.png"));
        //image = new Texture(new FileHandle(new File("src/res/assets/player.png")));
        //image = new Texture(Gdx.files.internal("src/res/assets/player.png"));
    ...
    public void update(float delta) {
        ...
        // AnimTest1
        if (position.y > MainFile.HEIGHT - image.getHeight()) {
             position.y = MainFile.HEIGHT - image.getHeight();
             resetVelocity();
         }
         if (position.x > MainFile.WIDTH - image.getWidth()) {
             position.x = MainFile.WIDTH - image.getWidth();
             resetVelocity();
         }
        // }*/
