...
public class TextureRegion {
    ...
    public TextureRegion (BufferedImage texture) {
    ...
    public TextureRegion (BufferedImage texture, int width, int height) {
            this.texture = texture;
    ...
    /** @param width The width of the texture region. May be negative to flip the sprite when drawn.
     * @param height The height of the texture region. May be negative to flip the sprite when drawn. */
    public TextureRegion (BufferedImage texture, int x, int y, int width, int height) {
            this.texture = texture;
            setRegion(x, y, width, height);
    }

    public TextureRegion (BufferedImage texture, float u, float v, float u2, float v2) {
            this.texture = texture;
            setRegion(u, v, u2, v2);
    }
    ...
    public void setRegion (BufferedImage texture) {
            this.texture = texture;
            setRegion(0, 0, texture.getWidth(), texture.getHeight());
    }
    ...
    /** Helper function to create tiles out of the given {@link BufferedImage} starting from the top left corner going to the right and
     ...
     * @param tileHeight a tile's height in pixels
     * @return a 2D array of TextureRegions indexed by [row][column]. */
    public static TextureRegion[][] split (BufferedImage texture, int tileWidth, int tileHeight) {
