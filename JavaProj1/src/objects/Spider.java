...
// объект типа моб - Паук
public class Spider extends UniqueObject {
    private static final int Damage = 1; // урон который наносит этот тип мобов
    private static final int AggroRad = 4; // агрорадиус когда заметит
    private static final int HealthPoint = 10; // агрорадиус когда заметит
