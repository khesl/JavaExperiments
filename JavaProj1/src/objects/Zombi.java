...
// объект типа моб - Зомби
public class Zombi extends UniqueObject{
    private static final int Damage = 3; // урон который наносит этот тип мобов
    private static final int AggroRad = 3; // агрорадиус когда заметит
