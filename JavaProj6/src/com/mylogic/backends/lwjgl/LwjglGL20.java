 ...
 * 
 * @author mzechner */
class LwjglGL20 implements com.mylogic.graphics.GL20 {
	...
	private void ensureBufferCapacity (int numBytes) {
		if (buffer == null || buffer.capacity() < numBytes) {
			buffer = com.mylogic.utils.BufferUtils.newByteBuffer(numBytes);
	...
	private FloatBuffer toFloatBuffer (float v[], int offset, int count) {
		...
		floatBuffer.clear();
		com.mylogic.utils.BufferUtils.copy(v, floatBuffer, count, offset);
		return floatBuffer;
	}
	...
	private IntBuffer toIntBuffer (int v[], int offset, int count) {
		ensureBufferCapacity(count << 2);
		intBuffer.clear();
		com.mylogic.utils.BufferUtils.copy(v, count, offset, intBuffer);
		return intBuffer;
	}
	...
	public void glDrawElements (int mode, int count, int type, Buffer indices) {
		if (indices instanceof ShortBuffer && type == com.mylogic.graphics.GL20.GL_UNSIGNED_SHORT)
			GL11.glDrawElements(mode, (ShortBuffer)indices);
		else if (indices instanceof ByteBuffer && type == com.mylogic.graphics.GL20.GL_UNSIGNED_SHORT)
			GL11.glDrawElements(mode, ((ByteBuffer)indices).asShortBuffer()); // FIXME yay...
		else if (indices instanceof ByteBuffer && type == com.mylogic.graphics.GL20.GL_UNSIGNED_BYTE)
