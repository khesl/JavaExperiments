...
import static com.mylogic.graphics.g2d.SpriteBatch.*;

import com.mylogic.graphics.Color;
import com.mylogic.math.Rectangle;
import com.mylogic.math.MathUtils;
...
public class Sprite extends TextureRegion{
    ...
    public Sprite (BufferedImage texture, int srcWidth, int srcHeight) {
     ...
     * @param srcWidth The width of the texture region. May be negative to flip the sprite when drawn.
     * @param srcHeight The height of the texture region. May be negative to flip the sprite when drawn. */
    public Sprite (BufferedImage texture, int srcX, int srcY, int srcWidth, int srcHeight) {
