package course_1.module_2.Booleans.src;
...
public class Loader
{
    public static void main(String[] args)
    {
        ...
        System.out.println(powderAmount >= 400 ? sugarAmount >= 10 ? milkAmount >= 1000 ? oilAmount >= 30 ? "Congrats! You can create Pancakes"
                : "Oh no, you need more ingredients for Pancakes"
                : "Oh no, you need more ingredients for Pancakes"
                : "Oh no, you need more ingredients for Pancakes"
                : "Oh no, you need more ingredients for Pancakes");
